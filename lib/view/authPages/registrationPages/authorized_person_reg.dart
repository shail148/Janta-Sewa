                    ...
                    Form(
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomDropdown(
                            items: typesAuth,
                            selectedValue: typesAuth.contains(selectTypesAuth)
                                ? selectTypesAuth
                                : null,
                            onChanged: (value) {
                              setState(() {
                          ...
                          CustomDropdown(
                            items: authorizeArea,
                            selectedValue: authorizeArea.contains(selectedOrg)
                                ? selectedOrg
                                : null,
                            onChanged: (value) {
                              setState(() {
                          ...
                          CustomDropdown(
                            ...
                            selectedValue:
                                orgAppointedOfficials.contains(
                                  selectOrgAppointedOfficials,
                                )
                                ? selectOrgAppointedOfficials
                                : null,
                            onChanged: (value) {
                          ...
                          CustomDropdown(
                            items: members,
                            selectedValue: members.contains(selectMember)
                                ? selectMember
                                : null,
                            onChanged: (value) {
                              setState(() {
                          ...
                          CustomDropdown(
                            ...
                            selectedValue:
                                areaWiseRights.contains(selectAreaRights)
                                ? selectAreaRights
                                : null,
                            onChanged: (value) {
                              setState(() {
