...
class MpOfficeComplaintViewModel extends GetxController {
  ...
  Future<void> submitMpOfficeComplaint() async {
    ...
    try {
      ...
      dev.log('📤 MpOfficeComplaint Data: $data');

      final res = await _api.createMpOfficeComplaintApi(data, headers: headers, files: files);
      ...
      dev.log('❌ MpOfficeComplaint Error: $e\n$st');
