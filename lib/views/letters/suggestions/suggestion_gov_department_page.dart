...
import 'package:janta_sewa/view_models/controllers/suggestionViewModel/gov_department_suggestion_view_model.dart';
...
class _SuggestionForGovDepartmentState
  ...
  final suggestionVM = Get.put(GovtDepartmentSuggestionViewModel());
                          ...
                          () => CustomButton(
                            ...
                            onPressed: () {
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                suggestionVM.selectedSuggestionFor.value =
                                    selectedType ?? '';
                                suggestionVM.submitGovtDepartmentSuggestion();
                              }
                            },
                          ),
                        ),
