                    ...
                    Form(
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            controller: postingVM.fullName.value,
                            hintText: 'full_name'.tr,
                          ),
                          CustomLabelText(text: 'mobile'.tr),
                          CustomTextFormField(
                            controller: postingVM.mobile.value,
                            hintText: 'mobile'.tr,
                          ),
                          CustomLabelText(text: 'designation'.tr),
                          CustomTextFormField(
                            controller: postingVM.designation.value,
