...
import 'package:janta_sewa/view_models/controllers/complaintViewModel/complain_mp_office_view_model.dart';
...
class _MpofficeComplainState extends State<MpofficeComplain> {
  ...
  final mpOfficeVM = Get.put(ComplainMpOfficeViewModel());
  final List<String> complainTypes = ['arrangement'.tr, 'Staff'.tr, 'other'.tr];
  String? selectedType;
  @override
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            controller: mpOfficeVM.applicantName.value,
                          ...
                          CustomTextFormField(
                            controller: mpOfficeVM.applicantMobile.value,
                            hintText: 'mobile_number'.tr,
                          ),
                          CustomLabelText(isRequired: true, text: 'address'.tr),
                          CustomTextFormField(
                            controller: mpOfficeVM.address.value,
                            hintText: 'address'.tr,
                          ),
                          //compalain type
                          CustomLabelText(
