...
import 'package:janta_sewa/view_models/controllers/complaintViewModel/complain_politician_view_model.dart';
...
class _PoliticianComplainState extends State<PoliticianComplain> {
  ...
  final politicianVM = Get.put(ComplainPoliticianViewModel());
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            controller: politicianVM.policianName.value,
