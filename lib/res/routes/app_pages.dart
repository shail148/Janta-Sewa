...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: AppRoutes.forgotPasswordPage, page: () => const ResetPassword()),
    GetPage(name: AppRoutes.resetPasswordPage, page: () => const ResetPassword()),
    GetPage(name: AppRoutes.verifyForgotPasswordPage, page: () => const ForgotOtpVerification()),
    GetPage(name: AppRoutes.mainPage, page: () => const MainNewsDashboard()),
