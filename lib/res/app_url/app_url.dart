class AppUrl {
  static const String baseUrl = "https://janta-seva-backend.onrender.com/api/v1";
  ...
  //parliament visit
  static const String parliamentVisitApi = "$baseUrl/parliament-visit/parliament-visit";
  //work demand
  static const String newWorkDemandApi ="$baseUrl/work-demand/new-work-demand";
  static const String pendingWorkDemandApi ="$baseUrl/work-demand/pending-work-demand";
  static const String beneficiaryOrientedApi = "$baseUrl/work-demand/beneficiary-oriented";
  //services  department
  static const String constructionWorkApi = "$baseUrl/services/construction-work";
  static const String hospitalAdmissionApi = "$baseUrl/services/hospital-admission";
  ...
  static const String recommendationLetterApi ="$baseUrl/services/recommendation-letter";
  static const String complainLetterApi = "$baseUrl/services/complain-letter";
  static const String complainOfGovEmployeeApi ="$baseUrl/services/complain-of-gov-employee";
  static const String complainOfPoliticianApi = "$baseUrl/services/complain-of-politician";
  static const String complainOfNationalApi = "$baseUrl/services/complain-of-national";
  static const String complainOfMpOfficeApi = "$baseUrl/services/complain-of-mp-office";
